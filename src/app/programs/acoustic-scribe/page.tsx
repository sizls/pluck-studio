// ---------------------------------------------------------------------------
// Pluck / ACOUSTIC-SCRIBE – program landing page
// ---------------------------------------------------------------------------
//
...
// primitives + Pluck core attest + device-acoustic-fingerprint into
  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">ACOUSTIC-SCRIBE</h1>
