...
export function ReceiptView({ id }: ReceiptViewProps): ReactNode {
  ...
  const system = useDirectiveRef({ module: sbomAiRunReceiptModule });
  ...
  return (
    <>
      ...
      <section className="studio-hero">
        <h1 className="studio-hero-title">SBOM-AI provenance</h1>
      ...
      <section>
        ...
        <p>
          <a href="/programs/sbom-ai/run" style={NextActionStyle} data-testid="next-run">
            Publish another artifact
          </a>
          <a href="/programs/sbom-ai" style={NextActionStyle} data-testid="next-program">
            Back to SBOM-AI
          </a>
          {lookupUrl ? (
