// ---------------------------------------------------------------------------
// POST /api/programs/custody/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(opts: {
  ...
  return new Request("http://localhost:3030/api/programs/custody/run", {
    method: "POST",
...
describe("POST /api/programs/custody/run — guards", () => {
  ...
  it("returns 401 with signInUrl when no auth", async () => {
    ...
    expect(body.signInUrl).toContain("/programs/custody/run");
  });
});

describe("POST /api/programs/custody/run — bundleUrl validation", () => {
...
describe("POST /api/programs/custody/run — expectedVendor validation", () => {
...
describe("POST /api/programs/custody/run — success path", () => {
...
describe("POST /api/programs/custody/run — idempotency dedupe", () => {
...
describe("POST /api/programs/custody/run — rate-limit shared bucket", () => {
