...
function buildRequest(body: unknown): Request {
  return new Request("http://localhost:3030/api/programs/nuclei/run", {
    method: "POST",
    headers: HEADERS,
...
describe("POST /api/programs/nuclei/run — TOFU enforcement", () => {
...
describe("POST /api/programs/nuclei/run — validation", () => {
...
describe("POST /api/programs/nuclei/run — author handle squat (AE R1 S1)", () => {
...
describe("POST /api/programs/nuclei/run — success", () => {
...
describe("POST /api/programs/nuclei/run — RFC 8594 deprecation signaling", () => {
...
describe("POST /api/programs/nuclei/run — idempotency dedupe", () => {
