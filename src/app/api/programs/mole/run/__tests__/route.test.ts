// ---------------------------------------------------------------------------
// POST /api/programs/mole/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(body: unknown): Request {
  return new Request("http://localhost:3030/api/programs/mole/run", {
    method: "POST",
    headers: HEADERS,
...
describe("POST /api/programs/mole/run — validation", () => {
...
describe("POST /api/programs/mole/run — privacy invariant (canaryBody REJECTED on wire)", () => {
...
describe("POST /api/programs/mole/run — success", () => {
...
describe("POST /api/programs/mole/run — RFC 8594 deprecation signaling", () => {
...
describe("POST /api/programs/mole/run — idempotency dedupe", () => {
