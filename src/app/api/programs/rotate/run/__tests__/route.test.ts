// ---------------------------------------------------------------------------
// POST /api/programs/rotate/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(body: unknown): Request {
  return new Request("http://localhost:3030/api/programs/rotate/run", {
    method: "POST",
    headers: HEADERS,
...
describe("POST /api/programs/rotate/run — validation", () => {
...
describe("POST /api/programs/rotate/run — privacy invariant (private key material REJECTED)", () => {
...
describe("POST /api/programs/rotate/run — success", () => {
...
describe("POST /api/programs/rotate/run — idempotency dedupe", () => {
