// ---------------------------------------------------------------------------
// Pluck / AVAP – program landing page
// ---------------------------------------------------------------------------
//
// Phase 10 alpha. AVAP is the H1-killer composite program.
  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">AVAP</h1>
      ...
      <section>
        ...
        <p>
          ...
          verbs already shipping across the Pluck:
        </p>
