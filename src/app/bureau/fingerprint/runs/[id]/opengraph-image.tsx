// ---------------------------------------------------------------------------
// /bureau/fingerprint/runs/[id]/opengraph-image — auto-generated 1200×630 PNG
// ---------------------------------------------------------------------------
//
// Sibling to DRAGNET + OATH OG cards. FINGERPRINT magenta accent
// distinguishes the program. Same length cap, shape gate, and font
// scale as the other cards (shared logic via lib/phrase-id).
// ---------------------------------------------------------------------------
...
export const alt = "FINGERPRINT model-fingerprint scan receipt";
...
const FG_DIM = "#888273";
const BG = "#1a1a1a";
const ACCENT = "#a3208a"; // FINGERPRINT magenta
    ...
    (
      ...
      >
        ...
        >
          ...
          <span style={{ marginLeft: 16 }}>Pluck Bureau · FINGERPRINT</span>
        </div>
        ...
        >
          {vendor !== null ? (
            ...
            >
              Scan of <strong style={{ color: FG }}>{vendor}</strong>
            </div>
          ) : null}
          <div
            style={{
          ...
          >
            scan pending — anchored to Sigstore Rekor on completion
          </div>
        </div>
        ...
        >
          ...
          <span style={{ letterSpacing: "0.08em" }}>
            5-probe calibration · Ed25519-signed · drift-classified
          </span>
        </div>
      </div>
    ),
