// ---------------------------------------------------------------------------
// POST /api/programs/sbom-ai/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(body: unknown): Request {
  return new Request("http://localhost:3030/api/programs/sbom-ai/run", {
    method: "POST",
    headers: HEADERS,
...
describe("POST /api/programs/sbom-ai/run — validation", () => {
...
describe("POST /api/programs/sbom-ai/run — success", () => {
...
describe("POST /api/programs/sbom-ai/run — RFC 8594 deprecation signaling", () => {
...
describe("POST /api/programs/sbom-ai/run — idempotency dedupe", () => {
