// ---------------------------------------------------------------------------
// POST /api/programs/mole/run — MOLE seal-canary endpoint (DEPRECATED ALIAS)
// ---------------------------------------------------------------------------
//
...
export async function POST(req: Request): Promise<Response> {
    ...
    return NextResponse.json(
      {
        ...
        signInUrl: "/sign-in?redirect=/programs/mole/run",
      },
      { status: 401 },
    );
  }
  ...
  const body = parsed.value as MoleRequestBody;
