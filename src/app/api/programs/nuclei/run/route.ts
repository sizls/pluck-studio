// ---------------------------------------------------------------------------
// POST /api/programs/nuclei/run — NUCLEI publish endpoint (DEPRECATED ALIAS)
// ---------------------------------------------------------------------------
//
...
export async function POST(req: Request): Promise<Response> {
  ...
  const body = parsed.value as NucleiRequestBody;
  ...
  // author-scoped (`alice-…`) because `runIdForProgram` resolves
