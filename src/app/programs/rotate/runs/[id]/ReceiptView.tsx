...
export function ReceiptView({ id }: ReceiptViewProps): ReactNode {
  ...
  const system = useDirectiveRef({ module: rotateRunReceiptModule });
  ...
  // The probe response carries only public SPKI fingerprints; private
  // key material never appears in /v1/runs.
  ...
  return (
    <>
      ...
      <section className="studio-hero">
        <h1 className="studio-hero-title">ROTATE rotation</h1>
      ...
      <section>
        ...
        <p>
          <a href="/programs/rotate/run" style={NextActionStyle} data-testid="next-run">
            Rotate another key
          </a>
          <a href="/programs/rotate" style={NextActionStyle} data-testid="next-program">
            Back to ROTATE
          </a>
        </p>
      </section>
