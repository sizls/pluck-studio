// ---------------------------------------------------------------------------
// POST /api/programs/dragnet/run — contract tests
// ---------------------------------------------------------------------------
//
...
function buildRequest(opts: {
  ...
  return new Request("http://localhost:3030/api/programs/dragnet/run", {
    method: "POST",
...
describe("POST /api/programs/dragnet/run — CSRF defence", () => {
...
describe("POST /api/programs/dragnet/run — auth", () => {
...
describe("POST /api/programs/dragnet/run — body validation", () => {
...
describe("POST /api/programs/dragnet/run — output shape", () => {
...
describe("POST /api/programs/dragnet/run — idempotency dedupe (C1 fix)", () => {
...
describe("POST /api/programs/dragnet/run — rate limit", () => {
