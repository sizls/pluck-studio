// ---------------------------------------------------------------------------
// POST /api/programs/bounty/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(body: unknown): Request {
  return new Request("http://localhost:3030/api/programs/bounty/run", {
    method: "POST",
    headers: HEADERS,
...
describe("POST /api/programs/bounty/run — validation", () => {
...
describe("POST /api/programs/bounty/run — privacy invariant (auth tokens REJECTED)", () => {
...
describe("POST /api/programs/bounty/run — success", () => {
...
describe("POST /api/programs/bounty/run — RFC 8594 deprecation signaling", () => {
...
describe("POST /api/programs/bounty/run — idempotency dedupe", () => {
