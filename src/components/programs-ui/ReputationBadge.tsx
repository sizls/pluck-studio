...
// inline in the Studio /programs/reputation/[vendor] route).
//
...
function sanitiseId(value: string): string {
  // Match the Pluck vendor regex but applied for display – strip
...
/**
 * Component form. The Studio /programs/reputation/[vendor] route uses
...
export function ReputationBadge({
  ...
  const href = `${origin}/programs/reputation/${encodeURIComponent(safeVendor)}`;
