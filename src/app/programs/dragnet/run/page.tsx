// ---------------------------------------------------------------------------
// Pluck / DRAGNET — Run a probe (v1 activation entry point)
// ---------------------------------------------------------------------------
//
...
// program and get a receipt URL back?" Everything in 30/60/90/180
...
// Receipt: stub page at /programs/dragnet/runs/[id] shows "pending".
// ---------------------------------------------------------------------------
  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">Run a DRAGNET probe-pack</h1>
