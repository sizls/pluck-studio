// ---------------------------------------------------------------------------
// POST /api/programs/tripwire/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(body: unknown): Request {
  return new Request("http://localhost:3030/api/programs/tripwire/run", {
    method: "POST",
    headers: HEADERS,
...
describe("POST /api/programs/tripwire/run — validation", () => {
...
describe("POST /api/programs/tripwire/run — success", () => {
...
describe("POST /api/programs/tripwire/run — RFC 8594 deprecation signaling", () => {
...
describe("POST /api/programs/tripwire/run — idempotency dedupe", () => {
