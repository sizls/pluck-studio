...
import { CalendarStrip } from "../../../../../components/programs-ui/CalendarStrip";
import {
  ...
  return (
    <>
      ...
      <section className="studio-hero">
        <h1 className="studio-hero-title">NUCLEI registry entry</h1>
      ...
      <section>
        ...
        <p>
          ...
          <a href="/programs/nuclei/run" style={NextActionStyle} data-testid="next-run">
            Publish another pack
          </a>
          <a href="/programs/nuclei/leaderboard" style={NextActionStyle} data-testid="next-leaderboard">
            Leaderboard
          </a>
          <a href="/programs/nuclei" style={NextActionStyle} data-testid="next-program">
            Back to NUCLEI
          </a>
        </p>
      </section>
