// ---------------------------------------------------------------------------
// POST /api/programs/oath/run — contract tests
// ---------------------------------------------------------------------------
...
function buildRequest(opts: {
  ...
  return new Request("http://localhost:3030/api/programs/oath/run", {
    method: "POST",
...
describe("POST /api/programs/oath/run — guards", () => {
  ...
  it("returns 401 with signInUrl when no auth", async () => {
    ...
    expect(body.signInUrl).toContain("/programs/oath/run");
  });
...
describe("POST /api/programs/oath/run — body validation", () => {
...
describe("POST /api/programs/oath/run — success path", () => {
...
describe("POST /api/programs/oath/run — idempotency dedupe", () => {
...
describe("POST /api/programs/oath/run — rate limit shared bucket", () => {
