// ---------------------------------------------------------------------------
// Pluck / OATH — Run an OATH check (v2 generalization entry point)
// ---------------------------------------------------------------------------
//
// Second program activated through Studio. Uses the same shared
// programs-ui/forms primitives + a sibling Directive module
  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">Run an OATH verification</h1>
