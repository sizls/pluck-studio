...
interface RunResponse {
  runId?: string;
  /** Legacy /api/programs/rotate/run shape. */
  phraseId?: string;
...
export function RotateRunForm(): ReactNode {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      router.push(body.receiptUrl ?? `/programs/rotate/runs/${body.runId}`);
    } catch (err) {
      system.facts.errorMessage =
  ...
  return (
    <form onSubmit={onSubmit} data-testid="rotate-run-form">
      <StudioLabel text="Old key SPKI fingerprint">
        <StudioInput
          type="text"
      ...
      <StudioLabel text="New key SPKI fingerprint">
        <StudioInput
          type="text"
      ...
      <StudioLabel text="Operator note (optional)">
        <StudioTextarea
          name="operatorNote"
