...
export function ReceiptView({ id }: ReceiptViewProps): ReactNode {
  ...
  // Mirrors the FINGERPRINT/CUSTODY/MOLE probe.
  ...
  return (
    <>
      ...
      <section className="studio-hero">
        <h1 className="studio-hero-title">TRIPWIRE deployment</h1>
        ...
        <p style={{ marginTop: 8, fontSize: 12 }}>
          ...
          {isPhrase ? (
            <span style={{ marginLeft: 12, color: "var(--studio-fg-dim)", fontStyle: "italic" }}>
        ...
        {isPending ? (
          <p style={{ marginTop: 16, fontStyle: "italic", color: "var(--studio-fg-dim)" }} data-testid="pending-banner">
        ...
        {verdict === "machine-already-active" ? (
          <p style={{ ...StatLineStyle, color: "#a78a1f" }}>
            <strong data-testid="already-active-callout">
              ...
              existing one via{" "}
              <a href="/programs/rotate/run">/programs/rotate/run</a>{" "}
      ...
      <section>
        ...
        <p>
          ...
          <a href="/programs/tripwire/run" style={NextActionStyle} data-testid="next-run">
            Configure another machine
          </a>
          <a href="/programs/tripwire" style={NextActionStyle} data-testid="next-program">
            Back to TRIPWIRE
          </a>
          <a href="/programs/rotate/run" style={NextActionStyle} data-testid="rotate-link">
