// ---------------------------------------------------------------------------
// Pluck / CUSTODY — Verify a bundle by URL (server-signed receipt path)
// ---------------------------------------------------------------------------
//
// Sibling to /programs/custody/verify (journalist drag-and-drop, pure
  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">Verify a bundle</h1>
        ...
        <p className="studio-hero-tagline" style={{ marginTop: 12 }}>
          For a journalist's offline check (no network round-trip, no
          signed receipt), drop the bundle JSON onto{" "}
          <a href="/programs/custody/verify">
            <code>/programs/custody/verify</code>
          </a>
          .
        </p>
      </section>
