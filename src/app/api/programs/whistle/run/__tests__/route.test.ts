// ---------------------------------------------------------------------------
// POST /api/programs/whistle/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(opts: {
  ...
  return new Request("http://localhost:3030/api/programs/whistle/run", {
    method: "POST",
...
describe("POST /api/programs/whistle/run — guards", () => {
...
describe("POST /api/programs/whistle/run — body validation", () => {
...
describe("POST /api/programs/whistle/run — privacy invariant", () => {
...
describe("POST /api/programs/whistle/run — success path", () => {
...
describe("POST /api/programs/whistle/run — RFC 8594 deprecation signaling", () => {
...
describe("POST /api/programs/whistle/run — idempotency dedupe", () => {
