  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">Configure a tripwire</h1>
        <p className="studio-hero-tagline">
          ...
          <a href="/programs/rotate/run">/programs/rotate/run</a> when you
          retire a machine.
        </p>
      </section>
      ...
      <section>
        ...
        <ol style={{ lineHeight: 1.7 }}>
          ...
          <li>
            ...
            <a href="/programs/tripwire/me"><code>/programs/tripwire/me</code></a>.
          </li>
        </ol>
      </section>
    </>
