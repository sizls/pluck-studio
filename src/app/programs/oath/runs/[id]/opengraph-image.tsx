// ---------------------------------------------------------------------------
// /programs/oath/runs/[id]/opengraph-image — auto-generated 1200×630 PNG
// ---------------------------------------------------------------------------
//
// Sibling to DRAGNET's OG card. Different headline ("OATH verification"),
// different program color (yellow accent matching the OATH landing
// callout), shared phrase-id parsing + length cap + shape gate.
// ---------------------------------------------------------------------------
...
export const alt = "OATH verification receipt";
...
const FG_DIM = "#888273";
const BG = "#1a1a1a";
const ACCENT = "#a78a1f"; // OATH yellow callout accent
      ...
      >
        ...
        >
          {vendor !== null ? (
            ...
            >
              Verified <strong style={{ color: FG }}>{vendor}</strong>
            </div>
          ) : null}
          <div
            style={{
          ...
          >
            verification pending — anchored to Sigstore Rekor on success
          </div>
        </div>
        ...
        >
          ...
          <span style={{ letterSpacing: "0.08em" }}>
            DSSE · Origin-checked · sealed-claim TTL
          </span>
        </div>
      </div>
    ),
