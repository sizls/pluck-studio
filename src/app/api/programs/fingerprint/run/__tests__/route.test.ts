// ---------------------------------------------------------------------------
// POST /api/programs/fingerprint/run — contract tests (deprecated alias)
// ---------------------------------------------------------------------------
//
...
function buildRequest(opts: {
  ...
  return new Request("http://localhost:3030/api/programs/fingerprint/run", {
    method: "POST",
...
describe("POST /api/programs/fingerprint/run — guards", () => {
  ...
  it("returns 401 with signInUrl when no auth", async () => {
    ...
    expect(body.signInUrl).toContain("/programs/fingerprint/run");
  });
});

describe("POST /api/programs/fingerprint/run — body validation", () => {
...
describe("POST /api/programs/fingerprint/run — success path", () => {
...
describe("POST /api/programs/fingerprint/run — RFC 8594 deprecation signaling", () => {
...
describe("POST /api/programs/fingerprint/run — idempotency dedupe", () => {
...
describe("POST /api/programs/fingerprint/run — rate-limit shared bucket", () => {
