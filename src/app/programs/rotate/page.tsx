// ---------------------------------------------------------------------------
// Pluck / ROTATE – program landing page
// ---------------------------------------------------------------------------
//
  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">ROTATE</h1>
      ...
      <section style={CalloutStyle}>
        ...
        <p>
          ...
          otherwise would damage the integrity claim every other Pluck
          program leans on.
        </p>
      </section>
