...
// /api/programs/mole/run route stays alive as a deprecated alias for
...
interface RunResponse {
  runId?: string;
  /** Legacy /api/programs/mole/run shape. */
  phraseId?: string;
...
export function MoleRunForm(): ReactNode {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      router.push(body.receiptUrl ?? `/programs/mole/runs/${body.runId}`);
    } catch (err) {
      system.facts.errorMessage =
  ...
  return (
    <form onSubmit={onSubmit} data-testid="mole-run-form">
      ...
      <StudioLabel text="Canary content URL">
        <StudioInput
          type="url"
          name="canaryUrl"
          required
      ...
      <StudioLabel text="Fingerprint phrases">
        <StudioTextarea
