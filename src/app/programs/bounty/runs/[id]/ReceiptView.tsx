    ...
    <>
      ...
      <section className="studio-hero">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 16, flexWrap: "wrap" }}>
          {isPhrase ? (
            <PhraseSigil phraseId={id} programAccent="#1f7a3a" size={96} />
          ) : null}
      ...
      <section>
        ...
        <p>
          <a href="/programs/bounty/run" style={NextActionStyle} data-testid="next-run">
            File another bounty
          </a>
          <a href="/programs/bounty" style={NextActionStyle} data-testid="next-program">
            Back to BOUNTY
          </a>
          {programDossierUrl ? (
