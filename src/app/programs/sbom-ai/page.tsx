// ---------------------------------------------------------------------------
// Pluck / SBOM-AI – program landing page
// ---------------------------------------------------------------------------
//
// Phase 1.5 alpha. Renders the SBOM-AI charter + a search box for
// `pluck.run/programs/sbom-ai/<sha256>`. Phase 2+ wires the Kite Event
  ...
  return (
    <>
      <section className="studio-hero">
        <h1 className="studio-hero-title">SBOM-AI</h1>
      ...
      <section>
        ...
        <pre>
          <code>
            studio.pluck.run/programs/sbom-ai/&lt;sha256&gt;
          </code>
        </pre>
      </section>
