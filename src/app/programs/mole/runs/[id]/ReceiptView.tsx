...
export function ReceiptView({ id }: ReceiptViewProps): ReactNode {
  ...
  // Mirrors the DRAGNET/OATH probe. The probe response carries only
  // the run record; canary body content never appears in /v1/runs.
  ...
  return (
    <>
        ...
        {isReWitnessed ? (
          <p style={{ ...StatLineStyle, color: "#7fbe7f" }}>
            <strong data-testid="re-witnessed-callout">
              ...
              <a href="/programs/rotate">ROTATE ReWitnessReport</a> after a
      ...
      <section>
        ...
        <p>
          <a href="/programs/mole/run" style={NextActionStyle} data-testid="next-run">
            Seal another canary
          </a>
          <a href="/programs/mole" style={NextActionStyle} data-testid="next-program">
            Back to MOLE
          </a>
        </p>
      </section>
