...
// /api/programs/custody/run route stays alive as a deprecated alias for
...
interface RunResponse {
  runId?: string;
  /** Legacy /api/programs/custody/run shape. */
  phraseId?: string;
...
export function CustodyRunForm(): ReactNode {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      router.push(body.receiptUrl ?? `/programs/custody/runs/${body.runId}`);
    } catch (err) {
      system.facts.errorMessage =
  ...
  return (
    <form onSubmit={onSubmit} data-testid="custody-run-form">
      ...
      <StudioLabel text="Expected vendor (optional)">
        <StudioInput
          type="text"
          name="expectedVendor"
